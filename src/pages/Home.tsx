        ...
        <main className="max-w-4xl mx-auto space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              האפליקציה שלנו מציעה פתרון חדשני ויעיל לניהול לוגיסטי ושליטה
              במלאי, המותאם לצרכים של יחידות לוגיסטיות בארגונים ובמערכת הביטחון.
              מטרתנו היא לפשט את תהליך הניהול הלוגיסטי ולספק כלים חכמים לניהול
              יעיל ומדויק של ציוד, כך שתמיד תהיה שליטה מלאה בכל מה שקורה במחסנים
              ובמלאי.
            </p>
          </section>
          ...
          <section className="text-center mt-8">
            ...
            <p className="text-gray-600 mb-4">
              אם גם אתם רוצים להוביל את היחידה שלכם לניהול לוגיסטי חכם ויעיל
              יותר — זה הזמן להצטרף למהפכה.
            </p>
            <Button
              appearance="primary"
